...
var bytesToSkip = [][]byte{
	[]byte{116, 111, 112, 32, 45},                     // 'top -'
	[]byte{84, 97, 115, 107, 115, 58, 32},             // 'Tasks: '
	[]byte{37, 67, 112, 117, 40, 115, 41, 58, 32},     // '%Cpu(s): '
	[]byte{75, 105, 66, 32, 77, 101, 109, 32, 58, 32}, // 'KiB Mem : '
	[]byte{75, 105, 66, 32, 83, 119, 97, 112, 58, 32}, // 'KiB Swap: '
	[]byte{80, 73, 68, 32},                            // 'PID '
}
